...
import com.alwaysreading.app.data.BookRepository
import com.alwaysreading.app.data.db.AppDatabase
...
class AlwaysReadingApp : Application() {
    ...
    companion object {
        const val NOTIFICATION_CHANNEL_ID = "always_reading_persistent"
    }
